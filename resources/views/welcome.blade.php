...
<div
    ...
    <div class="nav-right-button">
        <a href="{{route('ready')}}" class="btn theme-btn theme-btn-outline mr-2"><i
                class="la la-user-check mr-1"></i> Employee</a>
        <a href="{{route('wait')}}" class="btn theme-btn theme-btn-outline mr-2"><i
                class="la la-user mr-1"></i> Client</a>
